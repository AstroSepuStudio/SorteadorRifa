...
var ASM_CONSTS = {
  7817716: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 7817771: ($0) => { performance.now = function() { return $0; }; },  
 7817819: ($0) => { performance.now = function() { return $0; }; },  
 7817867: () => { performance.now = Module['emscripten_get_now_backup']; }
};
